...
# Generar archivo
button_generar = tk.Button(root, text="Generar Carpeta", command= lambda: generarCarpeta(entry_registro.get(),entry_resultado.get(), entry_ruta_salida.get()))
